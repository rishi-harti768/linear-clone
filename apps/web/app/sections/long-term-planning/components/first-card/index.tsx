                  ...
                  <div className={styles.item}>
                    <div className={styles.item__group}>
                      <div className={styles.profile}>
                        <Image src="/user-4.jpg" alt="" width={18} height={18} />
                      </div>

                      <div className={styles.profile}>
                        <Image src="/user-5.png" alt="" width={18} height={18} />
                      </div>

                      <div className={styles.profile}>
                        <Image src="/user-6.jpg" alt="" width={18} height={18} />
                      </div>

                      <div className={styles.profile}>
                        <Image src="/user-7.jpg" alt="" width={18} height={18} />
                      </div>
                    </div>
                  </div>
                </div>
