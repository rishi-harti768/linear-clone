  ...
  return (
    <div className={styles.customer__grid}>
      <div className={styles.logo__grid}>
        <GridCell layer={layer} icon1={<Logo1 />} icon2={<Logo2 />} icon3={<Logo3 />} />
        <GridCell layer={layer} icon1={<Logo4 />} icon2={<Logo5 />} icon3={<Logo6 />} />
        <GridCell layer={layer} icon1={<Logo7 />} icon2={<Logo8 />} icon3={<Logo9 />} />
        <GridCell layer={layer} icon1={<Logo10 />} icon2={<Logo11 />} icon3={<Logo12 />} />
        <GridCell layer={layer} icon1={<Logo13 />} icon2={<Logo14 />} icon3={<Logo15 />} />
        <GridCell layer={layer} icon1={<Logo16 />} icon2={<Logo17 />} icon3={<Logo18 />} />
      </div>
    </div>
  );
};
