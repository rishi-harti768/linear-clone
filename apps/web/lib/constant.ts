...
import type { CarouselCardProps } from '@/app/sections/modern-product-teams/components/carousel-card';
...
export const foundationList: FoundationList = [
  {
    ...
    value: 'Built with a high-performance architecture and an obsessive focus on speed.',
  },
  {
    id: 'foundation-2',
    label: 'Enterprise-ready security',
    value: 'Best-in-class security practices keep your work safe and secure at every layer.',
  },
  {
    id: 'foundation-3',
    label: 'Engineered for scale',
    value: 'Built for teams of all sizes. From early-stage startups to global enterprises.',
  },
];
...
export const userCards: UserCardProps[] = [
  ...
  {
    id: 'user-card-3',
    title: 'Pressing "Enter" quickly when logging in via email generates multiple emails',
    img: '/user-3.jpg',
    name: 'Tuomas',
  },
];
