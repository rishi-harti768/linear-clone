    ...
    <Modal title="About Linearlite" isOpen={isOpen} onDismiss={onDismiss}>
      <div className="flex flex-col w-full px-8 py-5 overflow-y-auto prose prose-sm">
        <p className="my-1">
          ...
          <a href="https://linear.app" target="_blank" rel="noreferrer noopener">
            Linear
          </a>
          {` `}
          built using{` `}
          <a href="http://electric-sql.com" target="_blank" rel="noreferrer noopener">
            ElectricSQL
          </a>
        ...
        <p className="my-1">
          ...
          <a href="https://github.com/tuan3w" target="_blank" rel="noreferrer noopener">
            Tuan Nguyen
          </a>
          .
        </p>
