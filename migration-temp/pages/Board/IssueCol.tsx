...
function calculateWindow(startIndex: number, stopIndex: number): { offset: number; limit: number } {
  const offset = Math.max(0, Math.floor(startIndex / CHUNK_SIZE) * CHUNK_SIZE - CHUNK_SIZE);
